...
// Affichez la température en degrés Celsius et sa conversion en degrés Fahrenheit dans la console en utilisant une phrase descriptive
console.log("Il fait actuellement "+celsius+" degrés celsius."+" Ce qui équivaut à "+fahrenheit+" degrés fahrenheit.")
...
console.log("Aujourd'hui la température a augmentée, il fait actuellement "+celsius+" degrés celsius."+" Ce qui équivaut à "+fahrenheit+" degrés fahrenheit.");
